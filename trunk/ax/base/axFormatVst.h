...
class axInstanceVst : public axInstance
{
  ...
  public:
    ...
    //void prepare(void* aHost=NULL, void* aUser=NULL)
    //  {
    //    audioMaster = (audioMasterCallback)aHost;
    //    aeffect     = (AEffect*)aUser;
    //    vst_canProcessReplacing();
    //  }
    ...
    virtual void* entrypoint(void* ptr)
      {
        ...
        //trace("- setup instance");
        //mInstance->prepare((void*)audioMaster,&aeffect);
        //mInstance->setup((void*)audioMaster,&aeffect);
